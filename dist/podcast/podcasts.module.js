...
PodcastsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([podcast_entity_1.Podcast, episode_entity_1.Episode, review_entity_1.Review])],
        providers: [
            podcasts_service_1.PodcastsService,
            podcasts_resolver_1.PodcastsResolver,
            podcasts_resolver_1.EpisodeResolver,
            podcasts_resolver_1.ReviewResolver
        ]
    })
], PodcastsModule);
